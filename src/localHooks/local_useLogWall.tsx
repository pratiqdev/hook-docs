        ...
        const logObject = (obj: any) => {
            ...
            for (const [k, v] of Object.entries(obj)) { 
                if(k === 'title' || k === 'stack'){
                    ...
                    !settings.windowOnly && console.log(v)
                }else if(k === 'doc'){
                    logGroup.push({type:'p', level: level, value: docs(v)})
                    !settings.windowOnly && console.log(consoleDocs(v))
                    
                }else{
                    logGroup.push({type:'p', level: level, value: k + ': ' + v})
                    !settings.windowOnly && console.log(`${k}:`, v)
                }
            }
            ...
            if('stack' in obj){
                ...
                !settings.windowOnly && console.log(obj.stack)
             }
